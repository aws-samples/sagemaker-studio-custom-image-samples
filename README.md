...
- [beakerx](examples/beakerx-image) - This example uses the `BeakerX` kernel see [BeakerX](http://beakerx.com/) which allows you to use scala, java, clojure, kotlin, sql languages.
